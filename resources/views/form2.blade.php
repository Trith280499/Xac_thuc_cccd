        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td><input type="text" name="email_account" class="form-control" placeholder="Nhập email"></td>
              <td class="text-center"><input type="checkbox" name="reset_email"></td>
            </tr>
            <tr>
              <td>📝 Tài khoản VLE (học trực tuyến)</td>
              <td><input type="text" name="moodle_account" class="form-control" placeholder="Nhập tên đăng nhập"></td>
              <td class="text-center"><input type="checkbox" name="reset_moodle"></td>
            </tr>
            <tr>
              <td>🖥️ Tài khoản Microsoft Team</td>
              <td><input type="text" name="portal_account" class="form-control" placeholder="Nhập tài khoản Portal"></td>
